...
import com.unimarket.models.CartItemResponse
import com.unimarket.models.CartResponse
import com.unimarket.models.ListingResponse
...
object CartService {
    ...
    suspend fun addItem(buyerId: Int, req: com.unimarket.models.AddToCartRequest) {
        ...
        if (listingRow[Listings.sellerId] == buyerId) {
            throw IllegalArgumentException("You can't add your own listing to cart")
        }
    ...
    suspend fun clearCart(buyerId: Int) {
        dbQuery {
            CartItems.deleteWhere { CartItems.buyerId eq buyerId }
        }
    }
}
