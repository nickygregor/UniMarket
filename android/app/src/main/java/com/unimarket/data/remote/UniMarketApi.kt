...
interface UniMarketApi {
    ...
    @GET("listings/{id}")
    suspend fun getListingById(@Path("id") id: Int): Response<Listing>
    ...
    suspend fun checkout(@Header("Authorization") token: String): Response<Order>
    ...
    // ── Admin ────────────────────────────────────────────────────────────────
    @GET("admin/users")
    suspend fun getAllUsers(@Header("Authorization") token: String): Response<List<com.unimarket.domain.model.User>>
